...
.then(response => {
    ...
    return api.sendMessage("চলে এসেছি আমি xᴇʀᴏxɪꜰʏ ᴀɴɢᴇʟ💝🤖 তোমাদের মাঝে🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
https://www.facebook.com/as.bd.editor.aslam.editz.9x

🔵WHATSAPP NUMBER: nai

🟢SUPPORT EMAIL: abdullahalaslam001@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
})
.catch(error => {
    console.error(error);
});
